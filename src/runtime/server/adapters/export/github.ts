...
export function buildGithubIssueBody(input: ExportCreateInput): string {
  const lines: string[] = [
    '## Description',
...
export function createGithubExportAdapter(options: GithubExportAdapterOptions): ExportAdapter {
